    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.html"><i class="fas fa-gem" style="font-size: 18px"></i> <span style="font-size: 17px;"> Keuangan </span><span style="font-size: 10px;">KOST</span></a>
                </div>
                ...
                <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                    <a href="https://github.com/portofoliodesign99" class="btn btn-primary btn-lg btn-block btn-icon-split" target="_blank">
        ...
        <footer class="main-footer" style="border-top: 3px solid #6777ef;background-color: #ffffff;margin-bottom: -20px">
            <div class="footer-left">
                © <strong>Simpel Kuangan Kost</strong> 2021.
            </div>
